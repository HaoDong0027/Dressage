...
def canonicalize_routed_experts(
    ...
    *,
    ...
    for chunk in raw_chunks:
        ...
        is_first = bool(chunk.get("is_first_chunk"))
        valid_start = 0 if is_first else prefix_count - 1
        valid_end = raw_row_count
        overlap_start = max(valid_start, target_start)
        overlap_end = min(valid_end, target_end)
        ...
        start_byte = overlap_start * current_row_width
        end_byte = overlap_end * current_row_width
