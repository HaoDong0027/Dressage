...
def train(args):
    ...
    if not transfer_queue_enabled():
        raise ValueError(
            "Dressage TransferQueue async train entry requires "
            "DRESSAGE_ENABLE_TRANSFER_QUEUE=1"
        )
        ...
        try:
            ...
            try:
                ...
                if training_succeeded:
                    raise
                logger.exception("Failed to clear TransferQueue batch after training failure")
